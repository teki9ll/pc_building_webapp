...
if (isset($_POST['submit'])) {
    ...
    $sql = " INSERT INTO `cpu`(`cpu_id`,`parent_id`,`cpu_name`,`cpu_price`) VALUES ($partid,$parentid,'$partname', $partprice)";
        ...
        <form method="post">
            ...
            <div class="card">
                <div class="card-header bg-dark">
                    <h1 class="text-white"> Insert Cpu </h1>
                </div><br>

                <label> Cpu Id: </label>
                <input type="text" name="partid" class="form-control"> <br>

                <label> Cpu Brand Id: </label>
                ...
                <button class="btn btn-success" name="submit" type="submit"> Insert Cpu </button><br>
