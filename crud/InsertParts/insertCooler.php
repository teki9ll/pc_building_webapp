...
if (isset($_POST['submit'])) {
    ...
    $sql = " INSERT INTO `cooler`(`cooler_id`,`parent_id`,`cooler_name`,`cooler_price`) VALUES ($partid,$parentid,'$partname', $partprice)";
        ...
        <form method="post">
            ...
            <div class="card">
                <div class="card-header bg-dark">
                    <h1 class="text-white"> Insert Cooler </h1>
                </div><br>

                <label> Cooler Id: </label>
                <input type="text" name="partid" class="form-control"> <br>

                <label> Cooler Brand Id: </label>
                ...
                <button class="btn btn-success" name="submit" type="submit"> Insert Cooler </button><br>
