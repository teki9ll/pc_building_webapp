...
if (isset($_POST['submit'])) {
    ...
    $sql = " INSERT INTO `gpu`(`gpu_id`,`parent_id`,`gpu_name`,`gpu_price`) VALUES ($partid,$parentid,'$partname', $partprice)";
        ...
        <form method="post">
            ...
            <div class="card">
                <div class="card-header bg-dark">
                    <h1 class="text-white"> Insert gpu </h1>
                </div><br>

                <label> Gpu Id: </label>
                <input type="text" name="partid" class="form-control"> <br>

                <label> Gpu Brand Id: </label>
                ...
                <button class="btn btn-success" name="submit" type="submit"> Insert Gpu </button><br>
