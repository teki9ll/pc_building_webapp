...
if (isset($_POST['submit'])) {
    ...
    $sql = " INSERT INTO `cases`(`case_id`,`parent_id`,`case_name`,`case_price`) VALUES ($partid,$parentid,'$partname', $partprice)";
        ...
        <form method="post">
            ...
            <div class="card">
                <div class="card-header bg-dark">
                    <h1 class="text-white"> Insert Case </h1>
                </div><br>

                <label> Case Id: </label>
                <input type="text" name="partid" class="form-control"> <br>

                <label> Case Brand Id: </label>
                ...
                <button class="btn btn-success" name="submit" type="submit"> Insert Case </button><br>
