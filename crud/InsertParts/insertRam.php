...
if (isset($_POST['submit'])) {
    ...
    $sql = " INSERT INTO `ram`(`ram_id`,`parent_id`,`ram_name`,`ram_price`) VALUES ($partid,$parentid,'$partname', $partprice)";
        ...
        <form method="post">
            ...
            <div class="card">
                <div class="card-header bg-dark">
                    <h1 class="text-white"> Insert ram </h1>
                </div><br>

                <label> Ram Id: </label>
                <input type="text" name="partid" class="form-control"> <br>

                <label> Ram Brand Id: </label>
                ...
                <button class="btn btn-success" name="submit" type="submit"> Insert Ram </button><br>
